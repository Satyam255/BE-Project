                ...
                <div className='flex items-center border border-gray-200 rounded-xl p-1 bg-white'>
                  <button
                    ...
                    className={`p-2 rounded-lg transition-colors ${
                      viewMode === "grid" ? "bg-blue-600 text-white shadow-sm" : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-2 rounded-lg transition-colors ${
                      viewMode === "list" ? "bg-blue-600 text-white shadow-sm" : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"
                    }`}
                  >
              ...
              {savedJobList.length === 0 ? (
                ...
                <>
                  <div className={viewMode === 'grid' ? 
                    "grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4 lg:gap-6" : "space-y-4 lg:space-y-6"
                  }>
